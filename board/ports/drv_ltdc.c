...
static void MX_LTDC_Init(void)
{
  ...
  hltdc.Init.AccumulatedActiveW = LCD_HSYNC_WIDTH + LCD_HBP + LCD_WIDTH - 1;
  hltdc.Init.AccumulatedActiveH = LCD_VSYNC_HEIGHT + LCD_VBP + LCD_HEIGHT - 1;
  hltdc.Init.TotalWidth = LCD_HSYNC_WIDTH + LCD_HBP + LCD_WIDTH + LCD_HFP - 1;
  hltdc.Init.TotalHeigh = LCD_VSYNC_HEIGHT + LCD_VBP + LCD_HEIGHT + LCD_VFP -1 ;
  ...
  /* USER CODE BEGIN LTDC_Init 2 */
    ...
    rt_pin_write(LCD_DISP_GPIO_NUM, 1);
